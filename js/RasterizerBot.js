  ...
  define([], function() {
    ...
    RasterizerBot = (function() {
      function RasterizerBot() {
        this.deleteAreaToUpdateCallback = __bind(this.deleteAreaToUpdateCallback, this);
        this.testSaveOnServer = __bind(this.testSaveOnServer, this);
        this.getAreasToUpdateCallback = __bind(this.getAreasToUpdateCallback, this);
        this.getAreasToUpdate = __bind(this.getAreasToUpdate, this);
