...
(function() {
  ...
  define(['Tools/Tool'], function(Tool) {
    ...
    CarTool = (function(_super) {
      ...
      function CarTool() {
        this.howlerLoaded = __bind(this.howlerLoaded, this);
      ...
      CarTool.prototype.updateSound = function() {
        var maxRate, minRate, rate, _ref, _ref1, _ref2;
        minRate = 0.25;
        maxRate = 3;
        rate = minRate + Math.abs(this.car.speed) / this.constructor.maxSpeed * (maxRate - minRate);
        this.sound._rate = rate;
        if ((_ref = this.sound._activeNode()) != null) {
          if ((_ref1 = _ref.bufferSource) != null) {
            if ((_ref2 = _ref1.playbackRate) != null) {
              _ref2.value = rate;
            }
          }
        }
      ...
      CarTool.prototype.updateOtherCars = function() {
        var car, direction, username, _ref;
        _ref = R.cars;
