...
(function() {
  define(['utils', 'paper', 'coffee', 'mainRasterizer', 'coordinateSystems', 'global', 'ajax', 'options', 'socket', 'command', 'Item/item', 'Item/div', 'Item/lock', 'Item/path', 'Tool/tools', 'mod', 'rasterizer', 'editor', 'sound', 'modal', 'jquery', 'jqueryUi', 'mousewheel', 'scrollbar', 'tween', 'typeahead', 'modal', 'ace', 'jqtree'], function(utils, paper, CoffeeScript) {
