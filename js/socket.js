...
(function() {
  ...
  define(['socketio'], function(ioo) {
    ...
    Socket = (function() {
      function Socket() {
        this.onSetUserName = __bind(this.onSetUserName, this);
        this.startChatting = __bind(this.startChatting, this);
      ...
      Socket.prototype.onBounce = function(data) {
        var allowedFunctions, id, item, itemClass, itemMustBeRasterized, rFunction, tool, _ref, _ref1, _ref2, _ref3;
        if (R.ignoreSockets) {
          return;
        }
