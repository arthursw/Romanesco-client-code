...
(function() {
  ...
  define(['tinycolor', 'gui', 'colorpickersliders'], function(tinycolor, GUI) {
    var ColorController, Controller, ControllerManager, Folder;
    R.initializeGlobalParameters = function() {
    ...
    R.addFont = function(fontFamily, effect) {
    ...
    R.initTextOptions = function(data, textStatus, jqXHR) {
