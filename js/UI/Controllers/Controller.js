  ...
  define(['Utils/Utils'], function() {
    ...
    Controller = (function() {
      ...
      Controller.prototype.initialize = function() {
        var base, base1, base2, controllerBox, firstOptionalParameter;
        ...
        if (this.parameter.type === 'button' || this.parameter.type === 'action' || typeof this.parameter["default"] === 'function') {
          ...
          if ((base1 = this.parameter).onChange == null) {
            base1.onChange = this.parameter["default"];
          }
          if ((base2 = this.parameter)["default"] == null) {
            base2["default"] = this.parameter.onChange;
          }
        }
