  ...
  define(['Commands/Command', 'Items/Item', 'UI/ModuleLoader', 'spin', 'Items/Lock', 'Items/Divs/Div', 'Items/Divs/Media', 'Items/Divs/Text'], function(Command, Item, ModuleLoader, Spinner) {
    ...
    Loader = (function() {
      function Loader() {
        ...
        this.showLoadingBarCallback = __bind(this.showLoadingBarCallback, this);
        this.loadedAreas = [];
        this.debug = false;
        this.pathsToCreate = {};
      ...
      Loader.prototype.getAreasToLoad = function(scale, qZoom, t, l, b, r) {
        var areasToLoad, planet, pos, x, y, _i, _j;
        areasToLoad = [];
      ...
      Loader.prototype.parseNewItems = function(items) {
        var i, item, itemsToLoad, _i, _len;
        itemsToLoad = [];
    ...
    RasterizerLoader = (function(_super) {
      __extends(RasterizerLoader, _super);
