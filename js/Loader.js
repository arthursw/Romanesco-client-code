...
(function() {
  ...
  define([], function() {
    ...
    Loader = (function() {
      ...
      Loader.prototype.unloadAreas = function(area, qZoom) {
      ...
      Loader.prototype.getAreasToLoad = function(scale, t, l, b, r) {
        ...
        for (x = _i = l; scale > 0 ? _i <= r : _i >= r; x = _i += scale) {
          for (y = _j = t; scale > 0 ? _j <= b : _j >= b; y = _j += scale) {
            ...
            if (R.rasterizerMode) {
              ...
              if (!R.areaIsLoaded(pos, planet, qZoom)) {
                area = {
                  pos: pos,
                  planet: planet
                };
      ...
      Loader.prototype.load = function(area) {
        ...
        areasToLoad = this.getAreasToLoad(scale, t, l, b, r);
      ...
      Loader.prototype.updateDebugPaths = function(limit, bounds, t, l, b, r) {
        ...
        R.debugLayer.addChild(this.unloadRectangle);
        ...
        R.debugLayer.addChild(this.viewRectangle);
        ...
        R.debugLayer.addChild(this.limitRectangle);
      };
